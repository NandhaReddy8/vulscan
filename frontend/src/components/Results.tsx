...
import ReportRequestDialog, { ReportFormData } from './ReportRequestDialog';
...
const Results: React.FC<ResultsProps> = ({ isVisible, vulnerabilities, stats }) => {
  ...
  const handleReportRequest = (formData: ReportFormData) => {
    console.log('Report requested:', formData);
    // TODO: Implement report request API call
      ...
      <section className="mt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-br from-blue-800 to-blue-600 rounded-lg p-6 text-white h-fit sticky top-6 border border-blue-500/30">
            ...
            <h4 className="text-xl font-semibold mb-3">For detailed PDF Report !</h4>
            <p className="mb-6 opacity-90">
              Your scan has identified additional security concerns that require attention.
